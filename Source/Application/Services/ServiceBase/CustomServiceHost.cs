...
namespace Atlanta.Application.Services.ServiceBase
{
    ...
    public class CustomServiceHost : ServiceHost
    {
        ...
        ///  Constructor
        /// </summary>
        public CustomServiceHost(string serviceName, params Uri[] baseAddresses)
        ...
        ///  Constructor
        /// </summary>
        public CustomServiceHost(string contextName, string serviceName, params Uri[] baseAddresses)
